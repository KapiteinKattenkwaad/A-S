...
function initMap() {
  ...
  var map = new google.maps.Map(document.getElementById('map'), { zoom: 16, center: burgerij });
...
//form handling
var $form = $('form#form'),
    url = 'https://script.google.com/macros/s/AKfycbwmmC8zXEW8Tr_F7yGeqpTi66MSY2ZA-Ic16-0VlNyGrr-z9QSK/exec';
